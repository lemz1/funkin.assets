...
import stages.props.TankmanEndingSprite;
import funkin.Paths;
...
import stages.props.TankmanSpriteGroup;
...
class StressSong extends Song
{
  ...
  public override function onCountdownStart(event:CountdownScriptEvent):Void
  {
    ...
    if (tankmanGroup == null)
    {
      ...
      tankmanGroup = new TankmanSpriteGroup(PlayState.instance.currentVariation != 'default');
    }
  ...
  override function onSongRetry(event:SongRetryEvent)
  {
    ...
    {
      PlayState.instance.currentStage.getGirlfriend().reset(0, 0);
      trace('reset pico!');
    }
  }
  ...
  var tankmanCutscene:TankmanEndingSprite;
  ...
  function startEndCutscene()
  {
    ...
    tankmanCutscene = new TankmanEndingSprite(0, 0);
