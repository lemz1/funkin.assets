...
class SenpaiSong extends Song
{
  ...
  function transitionToDialogue()
  {
    ...
    var black:FlxSprite = new FunkinSprite(-20, -20).makeSolidColor(Std.int(FlxG.width * 1.5), Std.int(FlxG.height * 1.5), 0xFF000000);
    ...
    var tweenFunction = function(x:Float) {
